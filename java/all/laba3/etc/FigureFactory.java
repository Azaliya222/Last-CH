...
import all.laba3.primitives.third.Rhomb;
import all.laba3.primitives.third.Trapezoid;
import all.laba3.primitives.third.Ellipse;
import all.laba3.primitives.third.Rectangle;
...
public class FigureFactory {
    ...
    public TCircle createRandomCircle(){
        ...
        return new TCircle(center, radius, colors[colorIndex]);
    }
    public Ellipse createRandomEllipse(){
        ...
        return new Ellipse(center, smallSemiAxis, largeSemiAxis, colors[colorIndex]);
    }
